...
enum CollisionCategory {
    ...
    CATEGORY_SKILL = 0x0008,     // 技能：0000 0000 0000 1000
    CATEGORY_BLOCK_SKILL = 0x0010,
    CATEGORY_BULLET = 0x0020,
};

// 定义碰撞掩码（谁和谁碰撞）
enum CollisionMask {
    // 玩家：只和障碍物、边界、道具碰撞（不和玩家、子弹碰撞）
    MASK_PLAYER = CATEGORY_OBSTACLE | CATEGORY_BOUNDARY | CATEGORY_SKILL | CATEGORY_PLAYER | CATEGORY_BULLET,
    ...
    // 障碍物技能，可以阻碍子弹技能
    MASK_BLOCK_SKILL = CATEGORY_BULLET,

    MASK_BULLET = CATEGORY_PLAYER | CATEGORY_BLOCK_SKILL,
};
